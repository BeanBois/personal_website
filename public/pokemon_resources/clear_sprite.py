...
# Load the image
image = cv2.imread('chatbox_.png') #bgr format

background_color = [255, 255, 255]
#background_color1 = [248, 248, 248] for chatbox
#clear_sprite.py
...
#        elif pixel_color[0] == pixel_color[1] and pixel_color[1] == pixel_color[2]: for chatbox
#            rgba_image[y,x] = [248,248,248,255]


# Check if red value is greater than 90 and update the binary image

cv2.imwrite('chatbox.png', rgba_image)
